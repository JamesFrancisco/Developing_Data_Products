...
shinyUI(navbarPage("Select the best commuting car",
                   tabPanel("Table",
                            
                            # Sidebar
                            sidebarLayout(
                              sidebarPanel(
                                helpText("Provide information about your commute and the specifications of the car that you are interested in"),
                                ...
                                numericInput('gas', 'Daily Commuting Budget:', 10, min=1, max=1000),
